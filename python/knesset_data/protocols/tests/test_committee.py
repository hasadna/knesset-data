...
עוזר ראשי מחלקה משפטית, משרד האוצר

עמוס יוגב

–

מנהל תחום סיווג ארצי, משרד האוצר

קובי בוזו

–

מנהל תחום בכיר תכנון וכלכלה, משרד האוצר

רפאל חדד

–

מנהל פיתוח עסקים, משרד הכלכלה

שאול ששון

–

מנהל תחום תעשיות, משרד הכלכלה

גילה ורד

–

עו"ד, הרשות השניה לטלוויזיה ורדיו

חניתה חפץ

–

לוביסטית (פוליסי), מייצגת את סלקום""")
